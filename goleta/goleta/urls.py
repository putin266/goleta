...
router.register(r'app_detail', views.AppDetailViewSet)
...
urlpatterns = [
    ...
    url(r'^check_mobile_exist/(?P<mobile_number>1\d{10})/$', views.CheckMobileNumberExistView.as_view(),
        name='check_mobile_exist'),
